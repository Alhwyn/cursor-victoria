...
/** Horizontal community-gallery strip items (cursor.com/community style). */
...
/** Inspiration Board masonry cards (cursorwaterloo-style). */
...
export const communityIntro = {
  title: "Join the global Cursor community.",
  body: "Explore Cursor meetups, cafes, hackathons, and workshops around the world.",
  primaryCta: {
...
/** Photo strip under the community hero — city/place labels like cursor.com/community. */
...
/** Masonry Inspiration Board — projects people have built. */
export const inspirationBoardItems: InspirationBoardItem[] = [
  {
    id: "harbor-notes",
    description:
